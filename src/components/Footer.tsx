    ...
    <footer className="border-t border-border mt-20 py-10">
      <div className="mx-auto max-w-7xl px-6 flex flex-col items-center gap-4">
        ...
        <div className="mt-2 flex gap-6 text-[11px] uppercase tracking-widest font-bold text-muted">
          <Link href="/" className="hover:text-accent dark:hover:text-accent-gold transition-colors">Home</Link>
          <Link href="/novels" className="hover:text-accent dark:hover:text-accent-gold transition-colors">Browse</Link>
        </div>
      </div>
    </footer>
  )
